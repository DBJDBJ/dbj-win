...
// #include <string.h>         // was for memset
void* __stdcall memset(void*, int, size_t);
...
// DBJ: we want only in line implementation
// commenting this out will stop it to creeo back in
// in some yet misterious ways
// 
...
/// DBJ added BEGIN
/// this instead of memset, unles using intrinsic memset renders itself OK
__inline void* __cdecl dbj_setmem_(void* pTarget, int value, size_t cbTarget) {
